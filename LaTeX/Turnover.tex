...
%	\node[] () {\includegraphics[width=\linewidth]{PositionPlot}};
	\node[] () {\includegraphics[width=\linewidth]{PositionPlot_2}};
...
%	\node[anchor=east] at (6.5, -3) {\footnotesize pollen competition (ploidy-antagonism)};%, $s^\female < s^\female$};
...
\end{tikzpicture}
\caption{
Invasion fitness of a neo-sex-determining allele plotted against the relative genomic location of a locus under direct selection, \textbf{A}, for various selective regimes. 
