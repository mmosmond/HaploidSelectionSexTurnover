...
However, this sex-ratio selection can be overwhelmed when the driving allele has additional selective effects (e.g., when it is detrimental for male diploids but beneficial for female diploids; Table \ref{tab:specialcases}), preventing the neo-W from invading. %and equalizing the sex ratio.
