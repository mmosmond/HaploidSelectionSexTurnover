...
In addition, we find that overdominance and/or sexually-antagonistic selection on sex-linked loci can maintain multiple sex-determining alleles (e.g. Figures \ref{fig:freqAll}B and \ref{fig:freqAll}C). 
...
We conclude that haploid selection should be considered as a potentially pivotal factor driving transitions between sex-determination systems. 
...
\textcolor{blue}{is this specific in any way to tight linkage, $r\approx0$? i see most of the plots referred to are tight linkage plots...}
