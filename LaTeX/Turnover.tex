...
Dominance is equal in both sexes, $h^\female=s^\male=3/4$. 
E-F show the temporal dynamics of neo-W frequency with parameters given by the asterisks in the corresponding A-D plot, with $r=1/200$, for four different $R$.
Black $R=1/1000$, Red $R=2/100$, Blue $R=1/10$, Green $R=1/2$.  
Dashed line in E-H gives ``fixation" of neo-W.
\textcolor{blue}{here and elsewhere, we may want to switch to plotting freq of neo-W in females, so that we can see if the difference from 0.5 is due to biased sex ratios or polymorphic SD}
}
