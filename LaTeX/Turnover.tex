...
At least one of these conditions is true if both haplotypes can spread ($\lambda_{mA}, \lambda_{ma} > 1$) and neither can be true if neither haplotype can spread ($\lambda_{mA}, \lambda_{ma} < 1$). 
