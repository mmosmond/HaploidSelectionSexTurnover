...
However, this sex-ratio selection can be overwhelmed when the driving allele has additional selective effects (e.g., when it is beneficial for male diploids but detrimental for female diploids; Table \ref{tab:specialcases}), preventing the neo-W from invading. %and equalizing the sex ratio.
...
Thus, haploid selection can favour heterogametic transitions both via sex-ratio selection and via fitness effects of alleles that are associated with the neo-sex-determining allele, and these selection pressures are often of equal magnitude. 
...
In panel A, there is no haploid selection ($t^\Hermaphrodite=\alpha^\Hermaphrodite_{\Delta}=0$) and selection in diploids is sexually antagonistic ($s^\male=-s^\female=1/10$, $h^\male=1-h^\female=3/10$), in which case the neo-sex-determining allele can only invade if it is more closely linked to the selected locus ($R<r$; gray region).
