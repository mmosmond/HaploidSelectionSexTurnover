...
\textcolor{blue}{shoot, i may have changed too much (i.e. strong selection too), but i did use the correct transformation. still, the form of S.8c,d seems wrong. I'll double check it.}
...
\chi_{ma}\left(\lambda_{mA}-1\right)+\chi_{mA}\left(\lambda_{ma}-1\right)>0.
\end{equation}
...
\centering
\smallskip
\caption{$\rho$ substitutions for different loci orders (assuming no interference)}
\begin{tabular}{l l}
\hline\hline
