...
\textcolor{blue}{following the logic above, it seems like we say we go from 8 eqns to 4 eqns by considering only one sex, and then from 4 eqns to 2 eqns by ignoring the ancestral SD allele. why then do we have the two quadratic problem?}
...
\centering
\smallskip
\caption{Values of $\rho$ for different loci orders assuming no interference and $r,R\in(0,1/2)$.}
\begin{tabular}{l l}
\hline\hline
