...
That is, selection on loci within the non-recombining region of the SDR can favour the invasion of a less closely linked neo-W, even in the absence of haploid selection (Figure \ref{fig:SexAntagTighter}). 
...
This is not possible with purely sexually-antagonistic selection \citep[][and supplementary material]{vanDoorn:2010hu}, but is possible with overdominance in at least one sex \textcolor{blue}{(check)}.
...
Haploid selection also makes polymorphic sex-determining systems more likely.
In fact, our explicit calculation of the invasion criteria for a neo-W entering a system with tight linkage between the ancestral SDR and the selected locus shows that protected polymorphisms, where the neo-W invades but has a frequency of less than 1/2 in females and the ancestral X and Y both segregate, are possible even in the absence of haploid selection (e.g., overdominance in males, Figure \ref{fig:temporalOverdominance}).
Protected polymorphisms are not possible with sexually-antagonistic selection alone \citep{vanDoorn:2010hu}.
Adding haploid selection to sexually-antagonistic selection changes this conclusion (Figure \ref{fig:SexAntagTighterMaleDrive}), as does ploidally-antagonistic selection (Figure \ref{fig:regionPloidAntag}).
...
\textcolor{blue}{I've added a bit to the end of the tight linkage section in the main text.}
