...
\textcolor{red}{Good point, not sure what's best for \textbf{the-term-formerly-known-as-$\rho$}. Yeah, Sally's written comment was something like ``$\chi$ is semi-standard notation for double recombination so it's use as a recombination rate might be confusing''.}
