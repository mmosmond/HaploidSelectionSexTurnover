...
The left panel demonstrates that both hypotheses can be simultaneously valid with overdominance in both sexes and sex differences in selection, which is also where there is selection for increased recombination between the sex chromosomes \citep[compare with figure 2(a) in][]{Otto2014}.
