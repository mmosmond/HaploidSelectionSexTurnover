...
\begin{tikzpicture}[remember picture]
	...
	\node[anchor=east] at (0.5, 1.5) {\footnotesize sexual-antagonism, $s^\male s^\female < 0$};
	\node[anchor=east] at (6.5, 1.5) {\footnotesize male drive, $s^\male s^\female > 0$};
	\node[anchor=east] at (0.5, -3) {\footnotesize pollen competition, $s^\male < s^\female$};
	\node[anchor=east] at (6.5, -3) {\footnotesize pollen comptition, $s^\female < s^\female$};
\end{tikzpicture}
\caption{
