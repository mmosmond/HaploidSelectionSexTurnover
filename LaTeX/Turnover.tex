...
\begin{figure}[!h]
\centering
\centerline{\includegraphics[width=0.35\linewidth]{Region_plot_combined_PloidAntag_Matt}}
\caption{
$h=0.75$
}
...
\textcolor{blue}{
did the region plots (Figure \ref{fig:regionPloidAntag}), yet to add the temporal dynamics
}
...
\textcolor{blue}{
these figures are now done (ensuring frequencies between 0 and 1), but yet to discuss in text.}
