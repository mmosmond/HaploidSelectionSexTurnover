...
Here, we give the conditions under which a neo-W invades an XY system assuming that the \textbf{A} locus is initially in close linkage with the ancestral sex-determining region ($r \approx 0$). 
...
%
%With haploid selection we have
...
Figure \ref{fig:Region_Plot_2a} shows that both the sex-specialist and perverse hypotheses are valid.
In fact, both can be simultaneously valid, which is generally where there is selection for increased recombination between the sex chromosomes \citep[][figure 2a]{Otto2014}.
...
\caption{
Colours indicate where sex-specialist (red) and perverse (blue) hypotheses are valid, i.e., where a stable resident equilibrium is invaded by a neo-W that is perfectly linked with the allele not fixed on the Y (red) or the allele that is fixed on the Y (blue). 
Note that the perverse equilibrium is only valid with overdominance and that both are simultaneously valid over much of the parameter space where increased recombination between the sex chromosomes is selected \citep[][figure 2a]{Otto2014}.
\textcolor{red}{can't make sex symbols in mathematica!}
}
\label{fig:Region_Plot_2a}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
