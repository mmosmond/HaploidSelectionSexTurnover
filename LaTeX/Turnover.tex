...
Firstly, non-Fisherian female-biased sex ratios can be favoured when there is local mate competition, in which brothers compete for mates \citep{Hamilton:1967ts}. 
...
In this study, we do not consider environmental condition dependence or local mate competition \citep[reviewed in][]{Charnov:1982wg,West:2009we}. 
