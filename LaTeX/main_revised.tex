...
This, in turn, can favour a new ZW sex-determining locus that has weaker linkage with loci under selection (a similar argument applies to ZW$\rightarrow$XY transitions), which was not \textcolor{red}{apparent/discovered/considered} in previous theory \cite{vanDoorn:2010hu}. 
...
Doing so, we reconcile the results of Kozielska et al. (2010)~\cite{Kozielska:2010vm} and Ubeda et al. (2015)~\cite{Ubeda:2015fx} by showing when new GSD systems that increase \textit{or} decrease linkage with loci under haploid selection spread. %that experience haploid selection.
...
In particular, we show that under a wide range of conditions, transitions to sex-determining systems that increase or decrease the sex-ratio bias are favoured \textit{equally strongly}. %(and in situations where sex-ratio biases are ancestrally present or absent). 
...
If $r<1/2$, then associations between ancestral sex-determining alleles and selected alleles can be maintained in males. 
...
We begin by describing the conditions under which new sex determining alleles can spread within a population, without explicitly specifying ancestral allele frequencies.
...
First, invasion by a neo-Y (neo-W) does not directly depend on the fitness of female (male) diploids. %(for a given set of equilibrium allele frequencies).
...
\textbf{
With tight linkage between a selected locus and the ancestral sex-determining locus ($r\approx0$), haploid selection can drive trans-GSD transitions (XY $\leftrightarrow$ ZW) that weaken sex-linkage ($r<R$), even when selection is sexually-antagonistic with directional selection in each diploid sex.
These trans-GSD transitions are driven by selection to equalize the sex ratio.
As in Conclusion 2A, such transitions potentially shift sex determination to a different chromosome ($R=1/2$) and can lead to polymorphic sex-determination systems.}
\textcolor{red}{[consistent with special case of Kozielska et al 2010]}
...
As discussed above, $\lambda_{Y'\rvert R=1/2}^{(XY)}$ is necessarily less than one (cis-GSD transition), but $\lambda_{W'\rvert R=1/2}^{(XY)}$ (trans-GSD transition) can be greater than one if there is haploid selection (see Conclusion 2B).
...
In accordance with the latter mechanism, we find that sex-differences in selection at the haploid stage can favour trans-GSD transitions that tighten sex-linkage (Conclusion 2A). %, as exemplified in~\cite{Ubeda:2015fx} for ESD-GSD transitions. 
However, we also find that trans-GSD transitions can be favoured in cases where linkage with the sex-determining locus is actually weakened (Conclusions 1A-1C \& 2B, Fig \ref{fig:SexAntagTighter} \& \ref{fig:regionplots}), especially when there is haploid selection (Conclusion 2B, Figs \ref{fig:Combination_Centimorgans} \& \ref{fig:SexRatioBad}). 
Furthermore, we show that the spread of new sex-determination systems is not dominated by selection to balance the sex ratio (Conclusions 3 \& 4, Fig \ref{fig:SexRatioBad}). 
...
Significantly, with weak selection, we find that there is no difference in conditions allowing XY to ZW and ZW to XY transitions (Conclusion 3) %, indicating that transitions in sex determination are not predominantly predicted by their effect on the sex ratio (i.e., the sex-ratio bias created by male haploid selection facilitates the spread of a neo-W allele into an XY system to the same degree that male haploid selection drives the spread of a neo-Y into a ZW system with a 1:1 sex ratio). 
...
However, we show that, if selected loci are tightly linked to the ancestral sex-determining locus, they can drive trans-GSD transitions which reduce sex-linkage (Conclusions 1A-1C \& 2B), thus widening the range of genomic locations that could be driving observed trans-GSD transitions.
...
In particular, both can select for new sex-determining loci that are more loosely linked to loci under selection (Conclusions 1A-1C \& 2B). 
In addition, haploid selection can cause transitions in GSD analogous to those caused by purely sexually-antagonistic selection, eliminating the need for differences in selection between male and female diploids (Conclusion 2A).
...
Further, transitions involving haploid selection can be driven by sex-ratio selection or cause sex-ratio biases to evolve; to leading order, selection to balance the sex ratio and the benefits of hitch-hiking with haploid selected alleles are of equal magnitude (Conclusions 3 \& 4). 
