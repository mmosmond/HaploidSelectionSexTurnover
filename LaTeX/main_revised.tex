...
Panel B: Haploid selection is often sex-limited, occurring during haploid production or competition in either males or females. 
...
For example, if the $\mathbf{A}$ locus is unlinked to the ancestral sex-determining locus ($r=1/2$, which implies that $ \hat{p}^\male_Y-\hat{p}^\male_X =0$), a more closely linked neo-W ($R<1/2$) can always invade. Thus, 
...
\textbf{New sex-determining alleles (causing trans-GSD transitions, XY $\leftrightarrow$ ZW) can spread even if they arise less closely linked with a locus that experiences selection than the ancestral-sex-determining locus is ($r<R$), requiring haploid selection.}
\vspace{0.5cm}
...
To clarify the parameter space under which invasion occurs with weak selection ($\lambda_{W'}^{(XY)}>1$) and $R>r$, we focus on cases where dominance coefficients are equal in the two sexes, $h^\female=h^\male$, and haploid selection only occurs in one sex (e.g., during male meiosis only).
