...
\textbf{New sex-determining alleles (causing trans-GSD transitions, XY $\leftrightarrow$ ZW) are favoured if they are linked with an ancestrally-autosomal locus ($R<1/2$, $r=1/2$) that experiences (haploid and/or diploid) selection.}
\vspace{0.5cm}
