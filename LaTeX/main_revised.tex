...
Variation at such loci can favour the spread of new sex-determining systems in which the heterogametic sex changes (XY to ZW or ZW to XY) and the new sex-determining region is less closely linked (or even unlinked) to the locus under selection, which is not apparent from previous theory. 
...
We find that associations with haploid selected loci can drive transitions between sex-determining systems, without requiring selection to act differently in diploid males vs.\ females. 
Further, with haploid selection, transitions between male and female heterogamety can also evolve where linkage with the sex-determining locus is weakened. 
Unexpectedly, we find that the selective strengths exerted by the sex-ratio and associations with selected alleles are equivalent.
...
Our models extend these theories to include selection upon haploid genotypes (meiotic drive or gametic competition), which causes sex-ratio biases and occurs differently in male and female gametes. 
...
%MAJOR MECHANISMS
%(2) sex-antagonism
Loci experiencing sexual antagonism have been shown to favour the spread of new genetic sex-determining alleles that are closely linked~\cite{vanDoorn:2007eu,vanDoorn:2010hu,Muralidhar2018}. 
...
One novel feature of the models developed here is that, when considering loci in very tight linkage with the ancestral sex-determining locus (e.g., within the non-recombining region of a sex chromosome), % in the results section: `Tight linkage with the ancestral sex-determining locus'). 
...
we explicitly calculate ancestral equilibrium allele frequencies.
This analysis uncovers that, under various forms of selection, the ancestral-X can carry suboptimal alleles for females and/or the ancestral-Y can carry female-beneficial alleles. 
...
In particular, under a wide range of conditions, we show that haploid selection drives transitions in sex-determining system \textit{equally strongly} in situations where sex-ratio biases increase or decrease (and in situations where sex-ratio biases are present or absent). 
...
Together, in this context, our results suggest that sex ratio selection is not an overwhelming force driving transitions between sex-determining systems. 
...
Nevertheless, our supplementary analysis file (\nameref{file:Mathematica}) allows other dominance relationships between loci to be specified. 
...
\textcolor{red}{possibly simplify?}
...
%%\textcolor{red}{[new result because Kozielska had ancestrally-tight sex-linkage and Ubeda had ESD]}
%\vspace{0.5cm}
...
\noindent The numerical results of \cite{Ubeda:2015fx} are consistent with Conclusion 1B, but arise from an ESD to GSD transition, where the ancestral equilibrium is considerably simpler.
Conclusion 2 echoes the diploid-selection-only results of \cite{vanDoorn:2007eu,vanDoorn:2010hu}, but greatly extends the number of selective scenarios favouring transitions.
...
In Fig \ref{fig:SexRatioBad}, we also show that trans-GSD transitions in sex determination occur during which linkage with a haploid selected locus increases \textit{or} decreases. 
...
\textcolor{red}{Tight ancestral linkage favours looser linked SDRs with diploid selection only:}
\textcolor{red}{New sex-determining alleles are thought to spread when they arise in linkage with loci that experience sex differences in selection due to beneficial associations between alleles that determine sex and alleles that are favoured in that sex~\cite{vanDoorn:2007eu,vanDoorn:2010hu,Ubeda:2015fx,Muralidhar2018}. 
However, when loci are 
that tight ancestral-linkage of polymorphic loci, maintained by sexually-antagonistic selection or otherwise, can also drive trans-GSD transitions.
}

% Evidence
\textcolor{red}{Evidence: Our results show, however, that tight ancestral-linkage of polymorphic loci, maintained by sexually-antagonistic selection or otherwise, can also drive trans-GSD transitions. 
...
In agreement with this hypothesis, a recent transcriptome analysis in Rumex shows that pollen-biased expression (relative to expression in flower buds or leaves) is enhanced among XY-linked genes compared to autosomal genes or compared to hemizygous genes that are only linked to the X 
\cite{Sandler264382}. 
