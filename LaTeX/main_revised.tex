...
The difference in $A$-allele-frequency among Y-bearing sperm versus X-bearing sperm is given by $\hat{p}^\male_Y-\hat{p}^\male_X=V_{A}S_{A}(1-2r)/(2r)$. 
...
\textbf{new sex-determining alleles (causing cis- \textit{or} trans-GSD transitions) can spread if the arise in closer linkage with a locus that experiences haploid selection than the ancestral-sex-determining locus ($R<r$).} 
\vspace{0.5cm}
...
\textbf{new sex-determining alleles (causing trans-GSD transitions) can spread if they arise in looser linkage with a locus that experiences haploid selection than the ancestral-sex-determining locus ($r<R$). } 
\vspace{0.5cm}
...
We show that neo-W alleles can spread for when they are more closely \textit{or} more loosely linked to a locus that experiences haploid selection in Fig \ref{fig:Combination_Centimorgans} (c.f., Fig \ref{fig:SexAntagTighter}A for diploid sexually-antagonistic selection alone). 
In Fig \ref{fig:SexRatioBad}, we also show examples of trans-GSD transitions in sex determination during which linkage with a haploid selected locus increases \textit{or} decreases. 
When sex-linkage decreases ($R>r$), neo-W alleles can benefit from Y-associated alleles that have higher fitness in the female diploid phase but then dissociate from these alleles through recombination, which occurs before any subsequent haploid selection. 
...
Our model allows us to analytically compare GSD-GSD transitions where sex-ratio bias increases, decreases, or remains equal. 
...
\textbf{when selection is weak relative to recombination, the presence or absence of sex-ratio biases do not create an assymetry in the likelihood of GSD-GSD transitions. } 
\vspace{0.5cm}
