...
{\bf Supplementary \textit{Mathematica} file.}  This file can be used to re-derive our results and generate figures. Please contact authors for access (or for a PDF version).
