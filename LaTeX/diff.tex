...
%DIF ADD main_revision.tex   Sun Mar 25 13:34:14 2018
...
`Fisherian' \DIFdelbegin \DIFdel{sex ratio }\DIFdelend \DIFaddbegin \DIFadd{sex-ratio }\DIFaddend selection favours a 1:1 zygotic sex ratio when assuming that males and females are equally costly to produce~\cite{Fisher:1930wy,Charnov:1982wg}.
...
\DIFaddbegin \DIFadd{However, starting from ESD, Ubeda et al. (2015)~\mbox{%DIFAUXCMD
\cite{Ubeda:2015fx} }%DIFAUXCMD
have numerically shown that sex-specific meiotic drive can allow masculinizing and feminizing mutations to spread (i.e., ESD $\rightarrow$ GSD) despite causing a sex-ratio bias.
}\DIFaddend 

Here we use mathematical models to \DIFdelbegin \DIFdel{find }\DIFdelend \DIFaddbegin \DIFadd{clarify }\DIFaddend the conditions under which new sex-determining systems spread when individuals experience selection at both diploid and haploid stages, which allows fitness differences between the sexes and \DIFdelbegin \DIFdel{sex ratio }\DIFdelend \DIFaddbegin \DIFadd{sex-ratio }\DIFaddend biases to occur simultaneously. 
...
We use the term `meiotic drive' to refer to the biased (non-Mendelian) segregation of genotypes during gamete production (from one parent \DIFaddbegin \DIFadd{only}\DIFaddend ) and the term `gametic competition' to refer to selection upon haploid genotypes within a gamete/gametophyte pool (\DIFdelbegin \DIFdel{potentially from multiple }\DIFdelend \DIFaddbegin \DIFadd{from many }\DIFaddend parents); the term `haploid selection' encompasses both processes. 
...
Nevertheless, recent studies have demonstrated that sperm competition in animals\DIFaddbegin \DIFadd{, even within a single ejaculate, }\DIFaddend can alter haploid allele frequencies and increase offspring fitness~\cite{Immler:2014im,Alavioon2017}.
...
That is, new masculinizing mutations (neo-Y alleles) could be favoured via associations with alleles that are beneficial in the male haploid stage \DIFdelbegin \DIFdel{. 
}\DIFdelend \DIFaddbegin \DIFadd{(e.g., \mbox{%DIFAUXCMD
\cite{Ubeda:2015fx}}%DIFAUXCMD
). 
}\DIFaddend On the other hand, sex ratios can also become biased by linkage between the sex-determining locus and a locus that harbours genetic variation in haploid fitness.
For example, there are several known cases of \DIFdelbegin \DIFdel{sex ratio }\DIFdelend \DIFaddbegin \DIFadd{sex-ratio }\DIFaddend bias caused by sex-linked meiotic drive alleles (Burt and Trivers, 2006, Chapter 6~\cite{Burt:2006}) or selection among X- and Y-bearing pollen~\cite{Lloyd:1974tz,Conn:1981uw,Stehlik:2005ul,Stehlik:2006to,Field:2012fd,Field:2013cc}. 
\DIFaddbegin \DIFadd{Sex-ratio selection can thus select against the spread of linked sex-determining alleles and favour the invasion of alternative, unlinked sex-determination systems \mbox{%DIFAUXCMD
\cite{Kozielska:2010vm}}%DIFAUXCMD
.
%DIF > It is not immediately clear how the spread of new sex-determining systems would be influenced by the combination of sex ratio biases and associations with haploid selected alleles. 
}\DIFaddend It is not \DIFdelbegin \DIFdel{immediately clear how the spread of }\DIFdelend \DIFaddbegin \DIFadd{yet clear when }\DIFaddend new sex-determining \DIFdelbegin \DIFdel{systems would be influenced by the combination of sex ratio biases and }\DIFdelend \DIFaddbegin \DIFadd{alleles are favoured by }\DIFaddend associations with haploid selected alleles \DIFdelbegin \DIFdel{. 
}\DIFdelend \DIFaddbegin \DIFadd{vs. sex-ratio bias, especially under a wide range of possible diploid selection regimes (e.g., sex-antagonism, overdominance).	
}\DIFaddend 

We find that the spread of novel sex-determining systems is influenced by both Fisherian \DIFdelbegin \DIFdel{sex ratio }\DIFdelend \DIFaddbegin \DIFadd{sex-ratio }\DIFaddend selection and by selection on linked alleles. 
...
\DIFdelbegin \DIFdel{Surprisingly, Fisherian sex ratio }\DIFdelend \DIFaddbegin \DIFadd{Fisherian sex-ratio }\DIFaddend selection does not \DIFaddbegin \DIFadd{always }\DIFaddend dominate; it is possible for selection on linked alleles to drive turnover between sex-determining systems despite causing increasingly biased sex ratios\DIFaddbegin \DIFadd{, and our analytical results elucidate what is required for this to be so}\DIFaddend .
...
We \DIFdelbegin \DIFdel{can draw a number of key points about the }\DIFdelend \DIFaddbegin \DIFadd{draw three main conclusions about the generic }\DIFaddend invasion of neo-Y and neo-W mutations from Table \ref{tab:haplotype_growth}\DIFdelbegin \DIFdel{. 
First, Fisherian sex ratio selection will favour the spread of a neo-Y and inhibit the spread of a neo-W if the ancestral zygotic sex ratio is biased towards females, }\DIFdelend \DIFaddbegin \DIFadd{:
}\vspace{0.5cm}

\noindent\textit{\DIFadd{Conclusion 1: Fisherian sex-ratio selection will favour the spread of a neo-Y and inhibit the spread of a neo-W if the ancestral zygotic sex ratio is biased towards females}}\DIFadd{, }\DIFaddend $\zeta<1/2$ (i.e., the first factor of the $\Lambda_{mi}^{(XY)}$ is greater than one for a neo-Y and less than one for a neo-W).
...
\DIFdelbegin \DIFdel{Second, invasion by a neo-Y (neo-W) does not directly depend on the fitness of female (male) diploids}\DIFdelend \DIFaddbegin \vspace{0.5cm}

\noindent\textit{\DIFadd{Conclusion 2: invasion by a neo-Y (neo-W) does not directly depend on the fitness of female (male) diploids}}\DIFaddend . %(for a given set of equilibrium allele frequencies).
...
\DIFdelbegin \DIFdel{Finally, invasions by a neo-Y and a neo-W are qualitatively different}\DIFdelend \DIFaddbegin \vspace{0.5cm}

\noindent\textit{\DIFadd{Conclusion 3: invasions by a neo-Y and a neo-W are qualitatively different}}\DIFaddend .
...
Neo-W alleles, on the other hand, can invade an ancestral XY system under some conditions (the full invasion conditions are given in \nameref{app:inv_cond}; equations \ref{Binvasion} and \ref{Ainvasion})\DIFdelbegin \DIFdel{. 
Counterintuitively, selection on loci within the non-recombining region around the sex-determining locus can favour the invasion of a less closely linked neo-W, }\DIFdelend \DIFaddbegin \DIFadd{:
}\vspace{0.5cm}

\noindent\textit{\DIFadd{Conclusion 4: counterintuitively, selection on loci within the non-recombining region around the sex-determining locus ($r\approx0$) can favour the invasion of a less closely linked neo-W ($r<R$)}}\DIFadd{, }\DIFaddend whatever the form of selection maintaining a polymorphism (sexually-antagonistic selection, overdominance, ploidally-antagonistic selection, or some combination, Fig \ref{fig:SexAntagTighter}, \nameref{fig:temporalOverdominance}, \nameref{fig:regionPloidAntag}, and \nameref{fig:SexAntagTighterMaleDrive}).  
...
This \DIFdelbegin \DIFdel{can allow neo-W invasion }\DIFdelend \DIFaddbegin \DIFadd{implies: 
}\vspace{0.5cm}

\noindent\textit{\DIFadd{Conclusion 5: with intermediate recombination between the ancestral sex-determining allele and a selected locus, $0<r<1/2$, a less closely linked neo-W ($r<R$) can invade}} \DIFaddend ($\lambda_{W'}^{(XY)}>1$)\DIFdelbegin \DIFdel{, even when the new sex-determining locus is less closely linked to the selected locus ($R>r$).
}\DIFdelend \DIFaddbegin \DIFadd{.
}\vspace{0.5cm}
...
When $R<1/2$, the invading neo-Y becomes associated with the male meiotic drive allele and the zygotic sex ratio actually evolves to become male-biased \DIFaddbegin \DIFadd{(similar to the scenario considered in \mbox{%DIFAUXCMD
\cite{Ubeda:2015fx}}%DIFAUXCMD
)}\DIFaddend .
...
\DIFaddbegin \noindent\textit{\DIFadd{Conclusion 6: when there is haploid selection, ESD can invade an ancestrally-XY system because it generates females that are either rare or have high fitness, in the same manner as a neo-W}}\DIFadd{.
}\vspace{0.5cm} 
...
\DIFaddbegin \DIFadd{\textcolor{red}{It should be noted, however, that the dynamics of sex-determining alleles with very weak effect will be influenced by genetic drift, which itself has been shown to cause trans-GSD transitions \cite{Veller2017}}.
}\DIFaddend Finally, while we have considered cis-GSD, trans-GSD, and GSD to ESD transitions, we have not explicitly considered ESD to GSD transitions. 
