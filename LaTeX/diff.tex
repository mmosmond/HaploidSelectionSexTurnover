...
%DIF ADD main_revised.tex   Sat May 19 22:37:20 2018
...
\DIFdelbegin \DIFdel{With weak selection and no haploid selection ($t^\Hermaphrodite=\alpha^\Hermaphrodite_{\Delta}=0$), the spread of }\DIFdelend \DIFaddbegin \vspace{0.5cm}
\noindent\textit{\DIFadd{Conclusion 3A:}}\DIFadd{\
}\textbf{\DIFadd{New sex-determining alleles (causing cis-GSD transitions, XY $\leftrightarrow$ XY or ZW $\leftrightarrow$ ZW) are favoured if they arise more closely linked with a locus that experiences (haploid and/or diploid) selection than the ancestral-sex-determining locus is ($R<r$).}}
\vspace{0.5cm}

\noindent
\DIFadd{Similarly, }\DIFaddend a neo-W is \DIFdelbegin \DIFdel{equivalent to the spread of a neo-Y ($\lambda_{W'}^{(XY)}=\lambda_{Y'}^{(XY)}$), such that trans-GSD transitions can also occur only if the new sex-determining locus is more closely linked to a locus under selection ($R<r$), as found by \mbox{%DIFAUXCMD
\cite{vanDoorn:2010hu}}%DIFAUXCMD
. 
When there is haploid selection, invasion also typically occurs when the neo-W }\DIFdelend \DIFaddbegin \DIFadd{typically favoured when it }\DIFaddend is more closely linked to the selected locus than the ancestral sex-determining region \DIFdelbegin \DIFdel{(Fig }\DIFdelend \DIFaddbegin \DIFadd{is, ($R<r$, e.g., Figs \ref{fig:SexAntagTighter}B and }\DIFaddend \ref{fig:Combination_Centimorgans}).
\DIFdelbegin \DIFdel{For example}\DIFdelend \DIFaddbegin \DIFadd{Specifically}\DIFaddend , if the \DIFdelbegin \DIFdel{$\mathbf{A}$ locus is unlinked to the ancestral sex-determining locus }\DIFdelend \DIFaddbegin \DIFadd{selected locus }\DIFaddend (\DIFaddbegin \DIFadd{$\mathbf{A}$) is ancestrally autosomal (}\DIFaddend $r=1/2$\DIFaddbegin \DIFadd{, leading to $ \hat{p}^\male_Y-\hat{p}^\male_X =0$}\DIFaddend ), a \DIFdelbegin \DIFdel{more closely linked }\DIFdelend neo-W \DIFaddbegin \DIFadd{linked to the selected locus }\DIFaddend ($R<1/2$) \DIFdelbegin \DIFdel{can always invade. 
...
%DIF < , as in the case of the neo-Y. 
}\DIFdelend \DIFaddbegin \DIFadd{will spread ($\lambda_{W'}^{(XY)}>1$). 
}\DIFaddend 
...
}\textbf{\DIFadd{New sex-determining alleles (causing trans-GSD transitions, XY $\leftrightarrow$ ZW) are favoured if they are linked with an ancestrally-autosomal locus ($R<1/2$, $r=1/2$) that experiences (haploid and/or diploid) selection.}}
\vspace{0.5cm}
\DIFaddend 

\DIFaddbegin \noindent
\DIFadd{In the absence of haploid selection ($t^\circ=\alpha^\circ_{\Delta}=0$), Eq }\eqref{eq:lambda_neoW} \DIFadd{indicates that trans-GSD transitions can occur if and only if the new sex-determining locus is more closely linked to a locus under selection, $R<r$, as found by \mbox{%DIFAUXCMD
\cite{vanDoorn:2010hu}}%DIFAUXCMD
. 
...
}\textbf{\DIFadd{With haploid selection, new sex-determining alleles (causing trans-GSD transitions, XY $\leftrightarrow$ ZW) can spread even if they arise less closely linked with a locus that experiences selection than the ancestral-sex-determining locus is ($r<R$).}}
\vspace{0.5cm}
