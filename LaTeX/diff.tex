...
%DIF ADD main_revised.tex   Mon Apr 30 21:55:53 2018
...
selection on loci within the non-recombining region around the sex-determining locus can favour the invasion of a less closely linked }\DIFdelend \DIFaddbegin \DIFadd{Thus,
}\vspace{0.5cm}
...
\textbf{\DIFadd{Selection on loci in or near the non-recombining region around the sex-determining locus ($r\approx0$) prevents cis-GSD transitions (XY $\leftrightarrow$ XY, ZW $\leftrightarrow$ ZW) but can spur trans-GSD transitions (XY $\leftrightarrow$ ZW).}}
\DIFadd{\textcolor{red}{[Not clear from van Doorn \& Kirkpatrick 2007, 2010]}
}\vspace{0.5cm}

\noindent \DIFadd{Trans-GSD transitions can occur because, under some conditions, the }\DIFaddend neo-W \DIFdelbegin \DIFdel{, whatever }\DIFdelend \DIFaddbegin \DIFadd{can become more strongly specialized for females.
This does not depend on }\DIFaddend the form of selection maintaining a polymorphism (sexually-antagonistic selection, overdominance, ploidally-antagonistic selection, or some combination, Fig \ref{fig:SexAntagTighter}, \nameref{fig:temporalOverdominance}, \nameref{fig:regionPloidAntag}, and \nameref{fig:SexAntagTighterMaleDrive}).  
\DIFdelbegin \DIFdel{The conditions }\DIFdelend \DIFaddbegin 

\DIFadd{The conditions allowing trans-GSD transitions }\DIFaddend become more restrictive \DIFdelbegin \DIFdel{, however, }\DIFdelend with increasing recombination ($R$) between the new sex-determining locus and the selected locus.  
...
To \DIFdelbegin \DIFdel{develop an intuition for how less closely linked neo-W alleles invade ($R>r$), we here focus }\DIFdelend \DIFaddbegin \DIFadd{clarify the conditions under which trans-GSD transitions occur, we focus here }\DIFaddend on cases where there is no haploid selection \DIFaddbegin \DIFadd{(Fig \ref{fig:SexAntagTighter}A) }\DIFaddend and discuss the additional effect of haploid selection in \nameref{app:inv_cond} \DIFdelbegin \DIFdel{. 
}\DIFdelend \DIFaddbegin \DIFadd{(see also Conclusion 2B). 
...
\DIFdelbegin \DIFdel{When only one neo-W haplotype has growth rate greater than one (see Fig \ref{fig:regionplots}), a neo-W allele can invade as long as Eq }%DIFDELCMD < \eqref{eq:lambdasGen} %%%
...
%DIFDELCMD < %%%
\DIFdelend Given that the $a$ allele \DIFaddbegin \DIFadd{is fixed on the Y and }\DIFaddend can be considered ancestrally `male-beneficial'\DIFdelbegin \DIFdel{because it is fixed on Y backgrounds}\DIFdelend , it is surprising that neo-W-$a$ haplotypes can sometimes be favoured by selection in females ($\Lambda_{W'a}^{(XY)}>1$). 
...
\DIFaddend In some cases, both W-$A$ and W-$a$ haplotypes can spread.
...
\DIFaddbegin \DIFadd{From the arguments above and in }\nameref{app:inv_cond} \DIFadd{we conclude that
}\vspace{0.5cm}

\noindent\textit{\DIFadd{Conclusion 2A:}}
\textbf{
\DIFadd{With tight linkage between a selected locus and the ancestral sex-determining locus ($r\approx0$), trans-GSD transitions (XY $\leftrightarrow$ ZW) can be driven by selection to better specialize on the ancestrally-non-heterogametic sex.
These transitions weaken sex-linkage ($r<R$), potentially shifting sex determination to a different chromosome ($R=1/2$). 
Such transitions can lead to polymorphic sex-determination systems.
}}
\DIFadd{\textcolor{red}{[consistent with special case of Kozielska et al 2010]}
}\vspace{0.5cm} 

\nameref{app:inv_cond} \DIFadd{shows that Conclusion 2A holds with or without haploid selection and further demonstrates that
}\vspace{0.5cm}

\noindent\textit{\DIFadd{Conclusion 2B:}}
\textbf{
\DIFadd{With tight linkage between a haploid selected locus and the ancestral sex-determining locus ($r\approx0$), trans-GSD transitions (XY $\leftrightarrow$ ZW) can be driven by selection to better specialize on the ancestrally-non-heterogametic sex and/or sex-ratio selection.
Such transitions reduce sex ratio bias.
}}
\DIFadd{\textcolor{red}{[consistent with special case of Kozielska et al 2010]}
}
...
}\textbf{\DIFadd{New sex-determining alleles (causing cis- }\textit{\DIFadd{or}} \DIFadd{trans-GSD transitions) can spread if they arise more closely linked with a locus that experiences selection than the ancestral-sex-determining locus is ($R<r$).}}
\DIFadd{\textcolor{red}{[consistent with van Doorn \& Kirkpatrick 2007, 2010]} 
}\vspace{0.5cm}
...
}\textbf{\DIFadd{New sex-determining alleles (causing trans-GSD transitions, XY $\leftrightarrow$ ZW) can spread even if they arise less closely linked with a locus that experiences selection than the ancestral-sex-determining locus is ($r<R$), requiring haploid selection and some initial sex-linkage ($r<1/2$).}}
\DIFadd{\textcolor{red}{[consistent with examples in Ubeda et al 2015]}  
}\vspace{0.5cm}
...
\noindent\textit{\DIFadd{Conclusion 4A:}}
...
\DIFadd{\textcolor{red}{[new result]}  
}\vspace{0.5cm}
...
As discussed above, $\lambda_{Y'\rvert R=1/2}^{(XY)}$ is necessarily less than one \DIFaddbegin \DIFadd{(cis-GSD transition)}\DIFaddend , but $\lambda_{W'\rvert R=1/2}^{(XY)}$ \DIFaddbegin \DIFadd{(trans-GSD transition) }\DIFaddend can be greater than one if there is haploid selection \DIFaddbegin \DIFadd{(see Conclusion 3B)}\DIFaddend .
...
%DIFAUXCMD
\DIFdelend \DIFaddbegin \noindent\textit{\DIFadd{Conclusion 4B:}}
\textbf{
...
}\DIFdelend \DIFaddbegin \DIFadd{that tighten sex-linkage (Conclusion 3A). %DIF > , as exemplified in~\cite{Ubeda:2015fx} for ESD-GSD transitions. 
However, we also find that }\DIFaddend trans-GSD transitions can \DIFdelbegin \DIFdel{occur where the new }\DIFdelend \DIFaddbegin \DIFadd{be favoured in cases where linkage with the }\DIFaddend sex-determining locus is \DIFdelbegin \DIFdel{less closely linked to the locus under selection if }\DIFdelend \DIFaddbegin \DIFadd{actually weakened (Conclusions 2A, 2B \& 3B, Fig \ref{fig:SexAntagTighter} \& \ref{fig:regionplots}), especially when }\DIFaddend there is haploid selection (\DIFdelbegin \DIFdel{e.g.}\DIFdelend \DIFaddbegin \DIFadd{Conclusion 3B}\DIFaddend , Figs \ref{fig:Combination_Centimorgans} \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{\& }\DIFaddend \ref{fig:SexRatioBad}). 
\DIFdelbegin %DIFDELCMD < 
...
}\DIFdelend \DIFaddbegin \DIFadd{(Conclusions 4A \& 4B, Fig \ref{fig:SexRatioBad}). 
}
...
In particular, both can select for new sex-determining loci that are more loosely linked to loci under selection \DIFaddbegin \DIFadd{(Conclusions 2A, 2B \& 3B)}\DIFaddend . 
In addition, haploid selection can cause transitions \DIFaddbegin \DIFadd{in GSD }\DIFaddend analogous to those caused by purely sexually-antagonistic selection, eliminating the need for differences in selection between male and female diploids \DIFaddbegin \DIFadd{(Conclusion 2B \& 3B)}\DIFaddend .
