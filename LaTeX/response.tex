...
\begin{enumerate}
\item[(1)] ancestrally-tight sex-linkage allows trans-GSD transitions but not cis-GSD transitions (L228-230)
\item[(2A)] with ancestrally-tight sex-linkage, trans-GSD transitions (which weaken sex-linkage and can lead to polymorphic sex determination systems) can be driven by selection to better specialize on the ancestrally-non-heterogametic sex (L282-286)
\item[(2B)] with ancestrally-tight sex-linkage, haploid selection can spur trans-GSD transitions (which weaken sex-linkage and equalize the sex-ratio) even when selection is sexually-antagonistic in diploids  (L288-293)
\item[(3A)] when selection is weak relative to ancestral sex-linkage, cis- or trans-GSD transitions can occur when the new sex-determining allele increases linkage with selected loci (L324-326)
\item[(3B)] when selection is weak relative to ancestral sex-linkage, haploid selection allows trans-GSD transitions to occur even when the new sex-determining allele decreases linkage with the selected locus (L327-330)
\item[(4A)] when selection is weak relative to ancestral sex-linkage, sex-ratio selection is exactly equal in magnitude to the selection imposed by associations with selected alleles (and thus transitions can increase or decrease the sex-ratio bias) (L350-353)
\item[(4B)] transitions from genetic to environmental sex-determination are not straightforwardly predicted by selection to balance the zygotic sex ratio when haploid selection is present (L411-413)
%\vspace{0.25cm}\\
\end{enumerate}
