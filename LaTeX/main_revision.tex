...
Here we use mathematical models to clarify the conditions under which new sex-determining systems spread when individuals experience extremely general and potentially sex-specific selection at both diploid and haploid stages, which allows fitness differences between the sexes and sex-ratio biases to occur simultaneously. 
...
Second, Fisherian sex-ratio selection will favour the spread of a neo-Y and inhibit the spread of a neo-W if the ancestral zygotic sex ratio is biased towards females (i.e., the first factor of the $\Lambda_{mi}^{(XY)}$ is greater than one for a neo-Y and less than one for a neo-W when $\zeta<1/2$).
