...
Two previous numerical simulation studies have considered the spread of GSD with sex-specific meiotic drive~\cite{Kozielska:2010vm,Ubeda:2015fx} under a small number of possible genetic architectures and diploid selective regimes. 
Ubeda et al. (2015)~\cite{Ubeda:2015fx}, considers ancestral-ESD (with no sex ratio bias) and find that new GSD alleles can spread if they arise in linkage with meiotic drive loci. 
...
They find that new, unlinked, GSD systems can spread if they generate the rarer sex, creating a balanced sex ratio. 
That is, they conclude that Fisherian sex ratio selection caused by haploid selection favours new GSD systems. 
Here, we analytically find conditions under which new GSD or ESD systems spread with generic linkage between the loci involved (and generic sex-specific haploid and diploid selection). 
